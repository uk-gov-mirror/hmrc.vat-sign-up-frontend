...
object StoreIdentityVerificationHttpParser {
  type StoreIdentityVerificationResponse = Either[IdentityVerificationFailure.type, IdentityVerified.type]
  ...
  object IdentityVerificationFailure
}
