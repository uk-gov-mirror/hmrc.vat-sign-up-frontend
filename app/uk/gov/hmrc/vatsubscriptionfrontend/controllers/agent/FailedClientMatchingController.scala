...
import uk.gov.hmrc.vatsubscriptionfrontend.views.html.agent.failed_client_matching

import scala.concurrent.Future

@Singleton
class FailedClientMatchingController @Inject()(val controllerComponents: ControllerComponents)
