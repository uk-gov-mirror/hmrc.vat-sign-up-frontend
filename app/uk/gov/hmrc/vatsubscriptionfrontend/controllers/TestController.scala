...
@Singleton
class TestController @Inject()(implicit val appConfig: AppConfig, val messagesApi: MessagesApi) extends FrontendController with I18nSupport{

  def show() = Action { implicit request =>
    Ok(client_details(clientDetailsForm, routes.TestController.show()))
  }
