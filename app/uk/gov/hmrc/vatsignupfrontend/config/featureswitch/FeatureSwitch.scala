...
object FeatureSwitch {
  ...
  val switches: Set[FeatureSwitch] = Set(
    ...
    CharitableIncorporatedOrganisationJourney
  )
...
case object CharitableIncorporatedOrganisationJourney extends FeatureSwitch {
  override val name: String = s"$prefix.charitable-incorporated-organisation-journey"
