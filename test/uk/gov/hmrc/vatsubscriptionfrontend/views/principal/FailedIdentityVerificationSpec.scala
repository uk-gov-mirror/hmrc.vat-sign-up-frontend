...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{FailedIdentityVerification => messages}
...
class FailedIdentityVerificationSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.failed_identity_verification(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
