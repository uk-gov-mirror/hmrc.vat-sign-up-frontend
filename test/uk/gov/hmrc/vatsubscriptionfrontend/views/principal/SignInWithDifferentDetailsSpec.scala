...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{SignInWithDifferentDetails => messages}
...
class SignInWithDifferentDetailsSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.sign_in_with_different_details()(
    FakeRequest(),
    applicationMessages,
