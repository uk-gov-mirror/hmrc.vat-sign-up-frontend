...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{PrincipalCaptureCompanyNumber => messages}
...
class CaptureCompanyNumberSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.capture_company_number(
