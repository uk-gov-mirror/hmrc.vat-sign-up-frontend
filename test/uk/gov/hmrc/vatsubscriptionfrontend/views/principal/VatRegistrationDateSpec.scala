...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{VatRegistrationDate => messages}
...
class VatRegistrationDateSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.vat_registration_date(
