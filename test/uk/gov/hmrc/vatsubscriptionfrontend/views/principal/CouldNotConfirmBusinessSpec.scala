...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{CouldNotConfirmBusiness => messages}
...
class CouldNotConfirmBusinessSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.could_not_confirm_business(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
