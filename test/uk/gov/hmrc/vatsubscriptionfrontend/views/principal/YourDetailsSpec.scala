...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{YourDetails => messages}
...
class YourDetailsSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.your_details(
