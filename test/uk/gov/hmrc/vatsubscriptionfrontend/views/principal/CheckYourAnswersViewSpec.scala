...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{PrincipalCaptureBusinessEntity, PrincipalCheckYourAnswers => messages}
...
import uk.gov.hmrc.vatsubscriptionfrontend.views.helpers.CheckYourAnswersIdConstants._
...
class CheckYourAnswersViewSpec extends ViewSpec {
  ...
  def page(): Html = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.check_your_answers(
  ...
  "display the correct info for VatNumber" in {
    ...
    val expectedEditLink = uk.gov.hmrc.vatsubscriptionfrontend.controllers.principal.routes.CaptureVatNumberController.show().url
  ...
  "display the correct info for VatRegistrationDate" in {
    ...
    val expectedEditLink = uk.gov.hmrc.vatsubscriptionfrontend.controllers.principal.routes.CaptureVatRegistrationDateController.show().url
  ...
  "display the correct info for BusinessEntity" in {
    ...
    val expectedEditLink = uk.gov.hmrc.vatsubscriptionfrontend.controllers.principal.routes.CaptureBusinessEntityController.show().url
