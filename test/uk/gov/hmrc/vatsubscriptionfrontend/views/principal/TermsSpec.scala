...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{PrincipalTerms => messages}
...
class TermsSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.terms(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
