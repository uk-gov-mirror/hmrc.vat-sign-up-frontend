...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{PrincipalCaptureBusinessEntity => messages}
...
class CaptureBusinessEntitySpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.principal.capture_business_entity(
    businessEntityForm,
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
