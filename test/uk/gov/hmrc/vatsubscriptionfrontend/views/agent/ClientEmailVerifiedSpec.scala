...
import uk.gov.hmrc.vatsubscriptionfrontend.assets.MessageLookup.{ClientVerifiedEmail => messages}
...
class ClientEmailVerifiedSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsubscriptionfrontend.views.html.agent.client_verified_email()(
    FakeRequest(),
    applicationMessages,
    appConfig
  )
