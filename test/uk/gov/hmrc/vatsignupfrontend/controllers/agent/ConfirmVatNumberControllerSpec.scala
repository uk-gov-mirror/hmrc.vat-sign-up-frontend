...
import uk.gov.hmrc.vatsignupfrontend.httpparsers.StoreVatNumberHttpParser.{AlreadySubscribed, IneligibleVatNumber, NoAgentClientRelationship, StoreVatNumberFailureResponse, VatNumberStored}
