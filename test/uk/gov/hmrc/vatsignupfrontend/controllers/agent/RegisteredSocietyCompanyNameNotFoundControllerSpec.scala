...
class RegisteredSocietyCompanyNameNotFoundControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockControllerComponents {
  ...
  lazy val testGetRequest = FakeRequest("GET", "/client/registered-society-company-name-not-found")

  lazy val testPostRequest: FakeRequest[AnyContentAsEmpty.type] =
    FakeRequest("POST", "/client/registered-society-company-name-not-found")
