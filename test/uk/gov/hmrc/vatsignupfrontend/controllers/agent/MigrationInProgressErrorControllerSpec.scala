...
class MigrationInProgressErrorControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockControllerComponents {
  ...
  "Calling the show action of the cannot use service controller" should {
    "show the cannot use service page" in {
      ...
      val result = TestMigrationInProgressErrorController.show(request)
