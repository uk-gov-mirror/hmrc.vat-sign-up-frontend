...
class SignUpCompleteControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockControllerComponents {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.agent.resignup.sign_up_complete(SoleTrader, testVatNumber, SignUpAnotherClientController.submit())(
    FakeRequest("GET", "/client/sign-up-complete"),
    applicationMessages,
    appConfig
  )
