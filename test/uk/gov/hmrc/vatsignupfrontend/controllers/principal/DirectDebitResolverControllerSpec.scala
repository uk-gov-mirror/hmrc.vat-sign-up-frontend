...
class DirectDebitResolverControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockVatControllerComponents {

  object TestDirectDebitResolverController extends DirectDebitResolverController
