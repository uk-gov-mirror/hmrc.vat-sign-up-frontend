...
import uk.gov.hmrc.vatsignupfrontend.forms.validation.models.{FieldError, SummaryError}
...
package object forms {
  ...
  implicit class InvalidUtil(invalid: Invalid) {
    ...
    import uk.gov.hmrc.vatsignupfrontend.forms.validation.ErrorMessageFactory._
