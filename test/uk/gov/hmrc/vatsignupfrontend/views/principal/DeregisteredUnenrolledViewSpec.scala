...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{PrincipalDeregisteredUnenrolled => messages}
import uk.gov.hmrc.vatsignupfrontend.config.AppConfig
import uk.gov.hmrc.vatsignupfrontend.views.ViewSpec

class DeregisteredUnenrolledViewSpec extends ViewSpec {
  ...
  lazy val page: HtmlFormat.Appendable = uk.gov.hmrc.vatsignupfrontend.views.html.principal.deregistered_unenrolled(
    testLink)(
    FakeRequest(),
    applicationMessages,
