...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{BtaBusinessAlreadySignedUp => messages, Base}
...
class BusinessAlreadySignedUpSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.principal.bta.business_already_signed_up(
    postAction = testCall
  )(FakeRequest(),
    applicationMessages,
    appConfig
