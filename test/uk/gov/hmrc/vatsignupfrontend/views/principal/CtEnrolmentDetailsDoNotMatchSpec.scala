...
class CtEnrolmentDetailsDoNotMatchSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.principal.ct_enrolment_details_do_not_match(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
  ...
  "The Could not confirm business view" should {
    ...
    testPage.shouldHaveSubmitButton(messages.companyNumber)
