...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{PrincipalConfirmEmail => messages}
...
class ConfirmEmailSpec extends ViewSpec {
  ...
  lazy val page: HtmlFormat.Appendable = uk.gov.hmrc.vatsignupfrontend.views.html.principal.confirm_email(
    email = testEmail,
    postAction = testCall)(
    request,
