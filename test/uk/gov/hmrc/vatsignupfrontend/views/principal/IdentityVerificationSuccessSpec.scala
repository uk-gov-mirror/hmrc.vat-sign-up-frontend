...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{IdentityVerificationSuccess => messages}
...
class IdentityVerificationSuccessSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.principal.identity_verification_success(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
