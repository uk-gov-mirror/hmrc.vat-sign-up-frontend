...
class GotSoftwareViewSpec extends ViewSpec {
  ...
  lazy val page: HtmlFormat.Appendable = uk.gov.hmrc.vatsignupfrontend.views.html.principal.eligibility.got_software(testCall)(
    request,
  ...
  "Got Software" should {
    ...
    testPage.shouldHaveALink(messages.linkId, messages.softwareCompatible, appConfig.makingTaxDigitalSoftwareUrl)
