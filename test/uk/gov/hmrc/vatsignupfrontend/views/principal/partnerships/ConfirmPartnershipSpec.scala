...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{ConfirmPartnership => messages}
...
class ConfirmPartnershipSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.principal.partnerships.confirm_partnership(
