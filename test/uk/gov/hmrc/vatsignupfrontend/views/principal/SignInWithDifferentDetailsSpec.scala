...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{SignInWithDifferentDetails => messages}
...
class SignInWithDifferentDetailsSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.principal.sign_in_with_different_details()(
    FakeRequest(),
    applicationMessages,
