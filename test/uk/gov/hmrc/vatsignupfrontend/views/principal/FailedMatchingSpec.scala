...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{FailedMatching => messages}
...
class FailedMatchingSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.principal.failed_matching(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
