...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{AgreeCaptureEmail => messages}
...
class AgreeCaptureEmailSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.agent.agree_capture_email(
    postAction = testCall)(
    FakeRequest(),
    applicationMessages,
