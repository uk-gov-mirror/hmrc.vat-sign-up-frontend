...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{NotEnrolledToAS => messages}
...
class NotEnrolledToAgentServicesSpec extends ViewSpec {
  ...
  lazy val page: HtmlFormat.Appendable = uk.gov.hmrc.vatsignupfrontend.views.html.agent.not_enrolled_to_agent_services()(
    request,
