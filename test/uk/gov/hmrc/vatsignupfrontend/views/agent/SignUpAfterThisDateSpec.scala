...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{AgentSignUpAfterThisDate => messages}
...
class SignUpAfterThisDateSpec extends ViewSpec {
  ...
  lazy val page = uk.gov.hmrc.vatsignupfrontend.views.html.agent.sign_up_after_this_date(
    date = testDate)(
    FakeRequest(),
    applicationMessages,
