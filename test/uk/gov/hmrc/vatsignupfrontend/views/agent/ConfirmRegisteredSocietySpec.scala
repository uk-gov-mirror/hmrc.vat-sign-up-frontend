...
import uk.gov.hmrc.vatsignupfrontend.assets.MessageLookup.{AgentConfirmRegisteredSociety => messages}
...
class ConfirmRegisteredSocietySpec extends ViewSpec {
  ...
  lazy val page: HtmlFormat.Appendable = uk.gov.hmrc.vatsignupfrontend.views.html.agent.confirm_registered_society(
