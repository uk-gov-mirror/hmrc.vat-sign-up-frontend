...
import uk.gov.hmrc.vatsignupfrontend.helpers.servicemocks.StoreIdentityVerificationStub
import uk.gov.hmrc.vatsignupfrontend.httpparsers.StoreIdentityVerificationHttpParser.IdentityVerified
